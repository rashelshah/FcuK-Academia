...
export default async function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400..900&family=Rajdhani:wght@400;500;600;700&family=Teko:wght@400;500;600;700&family=Press+Start+2P&family=Pixelify+Sans:wght@400..700&family=VT323&family=Chakra+Petch:wght@400;500;600;700&display=swap" rel="stylesheet" crossOrigin="anonymous" />
      </head>
      <body
        suppressHydrationWarning
