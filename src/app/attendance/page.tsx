    ...
    <div className="flex flex-col gap-8 pb-32 pt-4">
      <header className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full overflow-hidden border border-white/10 relative">
          <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=150&auto=format&fit=crop" alt="Profile" className="object-cover w-full h-full" />
        </div>
        <span className="font-headline font-bold text-xl text-primary tracking-tighter lowercase">fcuk academia</span>
      </header>

      {/* Huge Aggregate Header */}
      <section className="relative mt-8">
        ...
        <div className="relative z-10">
          ...
          <span className="font-headline font-bold text-[7rem] leading-[0.85] tracking-tighter text-primary">77.5%</span>
        </div>
      </section>
      ...
      <GlowCard glowColor="error" className="relative overflow-hidden bg-gradient-to-r from-[#2c1310] to-[#140b0a] border-none !border-l-[4px] !border-l-error p-6 py-8 shadow-2xl">
        <div className="flex justify-between items-start">
          <div className="max-w-[60%]">
            ...
            <p className="font-body text-xs text-[#adaaaa] mt-1 pr-4">below the 80% safety threshold</p>
          </div>
          <div className="text-right">
            <span className="font-headline text-5xl font-bold text-error block leading-none">2</span>
      ...
      <section className="space-y-4 pt-4">
        ...
        <div className="bg-[#121212] border border-[#2a2a2a] rounded-[28px] p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
          <div className="flex justify-between items-baseline mb-6">
            ...
            <span className="font-headline text-4xl font-bold tracking-tighter text-secondary">81.2%</span>
          </div>
          <ProgressBar value={81.2} color="var(--secondary)" showText={false} className="mb-8" />
